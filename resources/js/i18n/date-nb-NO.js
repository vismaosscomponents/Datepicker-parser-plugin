...
Date.CultureInfo={
    ...
    regexPatterns:{
        ...
        sat: /^lørdag/i,
        future: /^neste/i,
        past: /^sen(este)?|førre|tidigere/i,
        add: /^(\+|eft(er)?|från)/i,
        subtract: /^(\-|inn(an)?|siden)/i,
        yesterday: /^i\s?g(år)?/i,
        today: /^i\s?(dag)?/i,
        tomorrow: /^i\s?m(orgen)?/i,
        now: /^n(u)?/i,
        millisecond: /^ms|milli(sekund)?(er)?/i,
        second: /^s|sek(und)?(er)?/i,
        minute: /^mn|min(ut)?(er)?/i,
        hour: /^t(imme)?r?/i,
        week: /^u(ke)?r?/i,
        month: /^m(åned)?(er)?/i,
        day: /^d(ag)?(ar)?/i,
